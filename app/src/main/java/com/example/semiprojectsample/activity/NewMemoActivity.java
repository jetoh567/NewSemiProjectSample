...
public class NewMemoActivity extends AppCompatActivity {
    ...
    private void saveProc() {
        ...
        FragmentCamera f1 = (FragmentCamera) mViewPagerAdapter.instantiateItem(mViewPager, 0);
        ...
        Log.e("SEMI", "memoStr: " + ", photoPath: " + photoPath);
        Toast.makeText(this, "memoStr: " + ", photoPath: " + photoPath, Toast.LENGTH_LONG).show();
