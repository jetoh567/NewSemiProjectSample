...
import static com.example.semiprojectsample.activity.CameraCapture2Activity.getResizedBitmap;
...
public class FragmentCamera extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mEdtPw1 = view.findViewById(R.id.edtPw1);
        mEdtPw2 = view.findViewById(R.id.edtPw2);
